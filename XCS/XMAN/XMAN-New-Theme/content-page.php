 ...
 */
 ...
 $title_before = '<' . $heading_tag . ' class="title">'; //same as finance v3 - different from canvas content-page.php (there it is title entry-title)
...
<article <?php post_class(); ?>>
	...
	<header>
		<?php the_title( $title_before, $title_after );  // in canvas content-page.php everything from <header> to </header> is not there ?>
	</header>
	<?php
